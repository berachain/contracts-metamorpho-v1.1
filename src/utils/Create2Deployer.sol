...
abstract contract Create2Deployer {
    ...
    /// @return addr The address of the deployed contract.
    function deployWithCreate2WithArgs(uint256 salt, bytes memory initCode, bytes memory args)
        internal
    ...
    /// @param args The constructor arguments to pass to the contract.
    /// @return addr The address of the deployed contract.
    function getCreate2AddressWithArgs(uint256 salt, bytes memory initCode, bytes memory args)
        internal
        pure
        returns (address)
    {
